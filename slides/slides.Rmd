...
Convert the following expression to R code:
...
Many built-in distribution functions in R:

They have prefix r, q, p, ... for random, ...

- probability density: d___
- cumulative probability density p____
- quantile: q___
- random draw: r____
